...
public class QuartzJobScheduler {
    ...
    @PostConstruct
    public void init() {
        logger.info(".........Configuration  Quartz........ ");
    }
    ...
    public JobDetail jobDetail() {
        ...
        return newJob().ofType(StatistiquesConsulattonByServiceJob.class).storeDurably().withIdentity(JobKey.jobKey("Qrtz_Job_Detail")).withDescription("Invoke ConsultationByServiceJob Job service...").build();
    }
   ...
   /* @Bean
    ...
    public CronTrigger trigger(JobDetail job){
          return newTrigger().forJob(job).withIdentity("StatistiquesConsultations", "Statistiques").withSchedule(cronSchedule("0 0 18 * * ?")).build();
    }
